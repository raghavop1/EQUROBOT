...
from EQUROBOT.utils.daxx_ban import admin_filter
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("EQUROBOT/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((575, 575))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('EQUROBOT/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('EQUROBOT/assets/font.ttf', size=61)
